                ...
                <div class="card border-0 shadow-sm"
                    ...
                    <div class="card-body py-4">
                        <div class="d-flex align-items-center gap-3 text-white">
                            ...
                            <div>
                                <h2 class="fw-bold mb-1">Buat Berita Baru</h2>
                                <p class="mb-0 opacity-90">Buat dan bagikan berita ke semua petugas dan warga asrama</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('admin.berita.store') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="mb-4">
                                ...
                                @enderror
                                <small class="text-muted">Contoh: Pengumuman Libur Nasional, Peraturan Baru Asrama</small>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control @error('isi_berita') is-invalid @enderror" id="isi_berita" name="isi_berita"
                                    rows="10" required placeholder="Tulis isi berita di sini...">{{ old('isi_berita') }}</textarea>
                                @error('isi_berita')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="text-muted">Jelaskan berita dengan detail</small>
                            </div>

                            <div class="alert alert-info" style="border-radius: 10px;">
                                <i class="bi bi-info-circle me-2"></i>
                                <strong>Info:</strong> Berita akan dikirim sebagai notifikasi ke semua petugas dan warga
                                asrama.
                            </div>
                            ...
                            <div class="d-flex gap-2 justify-content-end">
                                ...
                                <button type="submit" class="btn btn-primary"
                                    ...
                                    <i class="bi bi-send me-2"></i>Kirim Berita
                                </button>
                            </div>
                        </form>
                    </div>
