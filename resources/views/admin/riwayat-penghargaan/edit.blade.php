...
@section('title', 'Edit Riwayat Penghargaan - Admin')
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2 class="fw-bold mb-1"><i class="bi bi-pencil-square me-2 text-warning"></i>Edit Riwayat
                            Penghargaan</h2>
            ...
            <div class="col-lg-8 col-12">
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-4">
                        <form action="{{ route('admin.riwayat-penghargaan.update', $riwayat->id_riwayat_penghargaan) }}"
                            method="POST">
                            @csrf
                            @method('PUT')
                                ...
                                <select name="id_warga" id="id_warga"
                                    ...
                                    @foreach ($warga as $w)
                                        <option value="{{ $w->id_warga }}"
                                            {{ old('id_warga', $riwayat->id_warga) == $w->id_warga ? 'selected' : '' }}>
                            ...
                            <div class="mb-4">
                                ...
                                <select name="id_penghargaan" id="id_penghargaan"
                                    ...
                                    @foreach ($penghargaan as $p)
                                        <option value="{{ $p->id_penghargaan }}" data-poin="{{ $p->poin_reward }}"
                                            ...
                                            {{ old('id_penghargaan', $riwayat->id_penghargaan) == $p->id_penghargaan ? 'selected' : '' }}>
                                ...
                                <!-- Detail Penghargaan -->
                                <div id="penghargaanDetail" class="mt-3 p-3 bg-light rounded">
    ...
    @push('scripts')
        ...
        <script>
            $(document).ready(function() {
                ...
                // Show current penghargaan detail on load
                updatePenghargaanDetail();
                ...
                function updatePenghargaanDetail() {
                    const selectedOption = $('#id_penghargaan').find('option:selected');
